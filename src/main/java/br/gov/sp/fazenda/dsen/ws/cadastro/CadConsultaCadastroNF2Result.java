 ...
 */
public class CadConsultaCadastroNF2Result
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(CadConsultaCadastroNF2Result.class, true);

    public CadConsultaCadastroNF2Result() {
    }

    public CadConsultaCadastroNF2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CadConsultaCadastroNF2Result)) {
            return false;
        }
        CadConsultaCadastroNF2Result other = (CadConsultaCadastroNF2Result)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2", ">CadConsultaCadastroNF2Result"));
    }
}
