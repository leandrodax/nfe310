 ...
 */
public class SceRecepcaoDPECResult
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(SceRecepcaoDPECResult.class, true);

    public SceRecepcaoDPECResult() {
    }

    public SceRecepcaoDPECResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", ">sceRecepcaoDPECResult"));
    }
}
