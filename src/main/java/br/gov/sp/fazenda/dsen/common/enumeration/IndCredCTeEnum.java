 ...
 */
public enum IndCredCTeEnum {
    NAO_CREDENCIADO("0", "N\u00e3o credenciado para emiss\u00e3o da CT-e"),
    ...
    private IndCredCTeEnum(String codigo, String descricao) {
        this.a = codigo;
        this.b = descricao;
    }
    ...
    public static IndCredCTeEnum getEnumPeloCodigo(String string) {
        for (IndCredCTeEnum e : IndCredCTeEnum.values()) {
