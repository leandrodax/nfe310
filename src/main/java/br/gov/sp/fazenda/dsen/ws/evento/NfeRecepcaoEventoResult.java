...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeRecepcaoEventoResult.class, true);

    public NfeRecepcaoEventoResult() {
    }

    public NfeRecepcaoEventoResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeRecepcaoEventoResult)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", ">nfeRecepcaoEventoResult"));
    }
}
