 ...
 */
public class NfeConsulta2SoapStub
extends Stub
implements NfeConsulta2Soap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", ">nfeConsultaNF2Result"));
        oper.setReturnClass(NfeConsultaNF2Result.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", "nfeConsultaNF2Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        NfeConsulta2SoapStub.a[0] = oper;
    }

    public NfeConsulta2SoapStub() throws AxisFault {
        this(null);
    }

    public NfeConsulta2SoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public NfeConsulta2SoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", ">nfeConsultaNF2Result");
        this.b.add(qName);
        Class<NfeConsultaNF2Result> cls = NfeConsultaNF2Result.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", ">nfeDadosMsg");
        this.b.add(qName);
    ...
    public NfeConsultaNF2Result nfeConsultaNF2(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeConsultaNF2"));
        ...
        try {
            return (NfeConsultaNF2Result)_resp;
        }
        catch (Exception _exception) {
            return (NfeConsultaNF2Result)JavaUtils.convert((Object)_resp, NfeConsultaNF2Result.class);
        }
    }

    static {
        NfeConsulta2SoapStub.a();
    }
}
