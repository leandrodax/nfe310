 ...
 */
public class NfeRetRecepcao2SoapStub
extends Stub
implements NfeRetRecepcao2Soap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", ">nfeRetRecepcao2Result"));
        oper.setReturnClass(NfeRetRecepcao2Result.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", "nfeRetRecepcao2Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        NfeRetRecepcao2SoapStub.a[0] = oper;
    }

    public NfeRetRecepcao2SoapStub() throws AxisFault {
        this(null);
    }

    public NfeRetRecepcao2SoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public NfeRetRecepcao2SoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", ">nfeDadosMsg");
        this.b.add(qName);
        Class<NfeDadosMsg> cls = NfeDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", ">nfeRetRecepcao2Result");
        this.b.add(qName);
        cls = NfeRetRecepcao2Result.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public NfeRetRecepcao2Result nfeRetRecepcao2(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeRetRecepcao2"));
        ...
        try {
            return (NfeRetRecepcao2Result)_resp;
        }
        catch (Exception _exception) {
            return (NfeRetRecepcao2Result)JavaUtils.convert((Object)_resp, NfeRetRecepcao2Result.class);
        }
    }

    static {
        NfeRetRecepcao2SoapStub.a();
    }
}
