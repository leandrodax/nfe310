 ...
 *  br.gov.sp.fazenda.dsen.ws.evento.NfeCabecMsg
...
implements Serializable {
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "nfeCabecMsg"));
        ElementDesc elemField = new ElementDesc();
        elemField.setFieldName("CUF");
        elemField.setXmlName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "cUF"));
        ...
        elemField.setXmlName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "versaoDados"));
        elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        a.addFieldDesc((FieldDesc)elemField);
