 ...
 *  br.gov.sp.fazenda.dsen.view.CancelarNotaFiscalGUI$1
 *  br.gov.sp.fazenda.dsen.view.CancelarNotaFiscalGUI$2
 *  br.gov.sp.fazenda.dsen.view.CancelarNotaFiscalGUI$3
 *  br.gov.sp.fazenda.dsen.view.CancelarNotaFiscalGUI$4
...
public class CancelarNotaFiscalGUI
extends DSGEDialog {
    ...
    public CancelarNotaFiscalGUI(Frame parent) {
    ...
    public CancelarNotaFiscalGUI(Dialog parent) {
        super((Window)parent, true);
        this.a();
        this.c();
        WindowManager.getInstance().centralizarDialogo((JDialog)this);
    ...
    private void a() {
        ...
        this.setTitle("Cancelando Nota(s) Fiscal(is) Eletr\u00f4nica(s).");
        this.a.setText("Cancelando Nota(s) Fiscal(is) Eletr\u00f4nica(s).");
    ...
    private void c() {
        ...
        this.a.addColumn(4, "resultadoCancelamento", "Resultado do Cancelamento", false);
    ...
    public void addNfeTO(NotaFiscalTO cTO) {
        this.a.addTO((BaseTO)cTO);
    }
