 ...
 *  br.gov.sp.fazenda.dsen.reportdata.ImpressaoDanfeInfComplRD
...
public class ImpressaoDanfeInfComplRD
implements ReportData {
    ...
    public Collection getData(Map map) throws DSGEReportException {
        System.out.println("(ImpressaoDanfeInfComplRD.getData) Inicio");
