...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeStatusServicoNF2Result.class, true);

    public NfeStatusServicoNF2Result() {
    }

    public NfeStatusServicoNF2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeStatusServicoNF2Result)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", ">nfeStatusServicoNF2Result"));
    }
}
