 ...
 */
public class NfeStatusServico2SoapStub
extends Stub
implements NfeStatusServico2Soap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", ">nfeStatusServicoNF2Result"));
        oper.setReturnClass(NfeStatusServicoNF2Result.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "nfeStatusServicoNF2Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        NfeStatusServico2SoapStub.a[0] = oper;
    }

    public NfeStatusServico2SoapStub() throws AxisFault {
        this(null);
    }

    public NfeStatusServico2SoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public NfeStatusServico2SoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", ">nfeDadosMsg");
        this.b.add(qName);
        Class<NfeDadosMsg> cls = NfeDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", ">nfeStatusServicoNF2Result");
        this.b.add(qName);
        cls = NfeStatusServicoNF2Result.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public NfeStatusServicoNF2Result nfeStatusServicoNF2(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeStatusServicoNF2"));
        ...
        try {
            return (NfeStatusServicoNF2Result)_resp;
        }
        catch (Exception _exception) {
            return (NfeStatusServicoNF2Result)JavaUtils.convert((Object)_resp, NfeStatusServicoNF2Result.class);
        }
    }

    static {
        NfeStatusServico2SoapStub.a();
    }
}
