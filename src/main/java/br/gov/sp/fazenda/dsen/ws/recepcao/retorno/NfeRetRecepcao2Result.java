 ...
 */
public class NfeRetRecepcao2Result
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeRetRecepcao2Result.class, true);

    public NfeRetRecepcao2Result() {
    }

    public NfeRetRecepcao2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeRetRecepcao2Result)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2", ">nfeRetRecepcao2Result"));
    }
}
