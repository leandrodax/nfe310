 ...
 */
public class NfeInutilizacao2SoapStub
extends Stub
implements NfeInutilizacao2Soap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", ">nfeInutilizacaoNF2Result"));
        oper.setReturnClass(NfeInutilizacaoNF2Result.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", "nfeInutilizacaoNF2Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        NfeInutilizacao2SoapStub.a[0] = oper;
    }

    public NfeInutilizacao2SoapStub() throws AxisFault {
        this(null);
    }

    public NfeInutilizacao2SoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public NfeInutilizacao2SoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", ">nfeDadosMsg");
        this.b.add(qName);
        Class<NfeDadosMsg> cls = NfeDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", ">nfeInutilizacaoNF2Result");
        this.b.add(qName);
        cls = NfeInutilizacaoNF2Result.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public NfeInutilizacaoNF2Result nfeInutilizacaoNF2(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeInutilizacaoNF2"));
        ...
        try {
            return (NfeInutilizacaoNF2Result)_resp;
        }
        catch (Exception _exception) {
            return (NfeInutilizacaoNF2Result)JavaUtils.convert((Object)_resp, NfeInutilizacaoNF2Result.class);
        }
    }

    static {
        NfeInutilizacao2SoapStub.a();
    }
}
