 ...
 *  br.gov.sp.fazenda.dsen.view.ConsultarNotaFiscalGUI$1
 *  br.gov.sp.fazenda.dsen.view.ConsultarNotaFiscalGUI$2
 *  br.gov.sp.fazenda.dsen.view.ConsultarNotaFiscalGUI$3
 *  br.gov.sp.fazenda.dsen.view.ConsultarNotaFiscalGUI$4
...
public class ConsultarNotaFiscalGUI
extends DSGEDialog {
    private static final long a = -5584231337863695943L;
    private JButton a;
    private JLabel a;
    private JLabel b;
    private JLabel c;
    ...
    public ConsultarNotaFiscalGUI(Frame parent) {
    ...
    public ConsultarNotaFiscalGUI(Dialog parent) {
        super((Window)parent, true);
        this.a();
        this.c();
        WindowManager.getInstance().centralizarDialogo((JDialog)this);
    ...
    private void a() {
        ...
        this.setTitle("Consultando Nota(s) Fiscal(is) Eletr\u00f4nica(s).");
        this.setAlwaysOnTop(true);
        this.setResizable(false);
        this.a.setText("Consultando Nota(s) Fiscal(is) Eletr\u00f4nica(s).");
    ...
    private void c() {
        ...
        this.a.addColumn(4, "resultadoConsulta", "Resultado da Consulta", false);
    ...
    public void addNfeTO(NotaFiscalTO nTO) {
