...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeDadosMsg.class, true);

    public NfeDadosMsg() {
    }

    public NfeDadosMsg(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro2", ">nfeDadosMsg"));
    }
}
