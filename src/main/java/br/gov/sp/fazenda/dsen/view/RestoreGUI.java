...
extends DSGESimplePanel {
    ...
    public RestoreGUI() throws DSGEViewException {
        this.a();
        this.b();
    ...
    private void a() {
        ...
        this.b = new JButton();
        this.a = new JLabel();
        this.b.setBorder(BorderFactory.createTitledBorder(null, "Restaurar Backup", 2, 0, new Font("Dialog", 1, 14), Color.blue));
        this.b.setName("pnlSelecionar");
        this.a.setEnabled(false);
        this.a.setName("txtLocal");
        this.c.setLabel("Selecionar");
        this.b.setText("Arquivo de Backup");
    ...
    private void b() {
        this.c.setActionCommand("selecionarRestore");
        this.b.setActionCommand("voltar");
        this.a.setActionCommand("executarRestore");
    }
