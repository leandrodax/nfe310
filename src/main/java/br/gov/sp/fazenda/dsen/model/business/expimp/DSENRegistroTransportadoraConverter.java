...
public class DSENRegistroTransportadoraConverter
extends DSGERegistroConverter {
    private static Map<String, String> a = new HashMap();

    protected Registro createBaseRegistro() {
        Registro base = new Registro();
        base.setTagXml("infTransportadora");
        Campo c = new Campo();
        c.setNome("qtde");
        c.setValueExp("#A");
        base.addCampo(c);
        base.setTipoRegistro("TRANSPORTADORA");
        return base;
    }

    protected InputStream getArquivoLayout(String version) {
        return this.getClass().getResourceAsStream(MessageFormat.format(DSENConstants.XML_TRANSPORTADORA_LAYOUT, StringHelper.getDigits((String)version)));
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            Scanner scanner = new Scanner(converter.getClass().getResourceAsStream("TRANSPORTADORA.txt"));
            ...
            registroTOMap.put("X", TransportadoraTO.class.getCanonicalName());
    ...
    static {
        a.put("X", TransportadoraTO.class.getCanonicalName());
