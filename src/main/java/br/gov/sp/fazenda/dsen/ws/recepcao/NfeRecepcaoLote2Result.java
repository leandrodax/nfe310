...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeRecepcaoLote2Result.class, true);

    public NfeRecepcaoLote2Result() {
    }

    public NfeRecepcaoLote2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeRecepcaoLote2Result)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", ">nfeRecepcaoLote2Result"));
    }
}
