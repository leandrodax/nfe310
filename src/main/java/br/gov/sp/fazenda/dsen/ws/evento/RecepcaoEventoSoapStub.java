 ...
 */
public class RecepcaoEventoSoapStub
extends Stub
implements RecepcaoEventoSoap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", ">nfeRecepcaoEventoResult"));
        oper.setReturnClass(NfeRecepcaoEventoResult.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", "nfeRecepcaoEventoResult"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        RecepcaoEventoSoapStub.a[0] = oper;
    }

    public RecepcaoEventoSoapStub() throws AxisFault {
        this(null);
    }

    public RecepcaoEventoSoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public RecepcaoEventoSoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", ">nfeDadosMsg");
        this.b.add(qName);
        Class<NfeDadosMsg> cls = NfeDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento", ">nfeRecepcaoEventoResult");
        this.b.add(qName);
        cls = NfeRecepcaoEventoResult.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public NfeRecepcaoEventoResult nfeRecepcaoEvento(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeRecepcaoEvento"));
        ...
        try {
            return (NfeRecepcaoEventoResult)_resp;
        }
        catch (Exception _exception) {
            return (NfeRecepcaoEventoResult)JavaUtils.convert((Object)_resp, NfeRecepcaoEventoResult.class);
        }
    }

    static {
        RecepcaoEventoSoapStub.a();
    }
}
