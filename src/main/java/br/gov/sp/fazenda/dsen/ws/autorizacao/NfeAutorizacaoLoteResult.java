...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeAutorizacaoLoteResult.class, true);

    public NfeAutorizacaoLoteResult() {
    }

    public NfeAutorizacaoLoteResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeAutorizacaoLoteResult)) {
            return false;
        }
        NfeAutorizacaoLoteResult other = (NfeAutorizacaoLoteResult)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeAutorizacao", ">nfeAutorizacaoLoteResult"));
    }
}
