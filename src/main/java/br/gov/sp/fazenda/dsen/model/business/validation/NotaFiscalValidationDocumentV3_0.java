 ...
 */
public class NotaFiscalValidationDocumentV3_0 {
    private NFeDocument a;
    private Log a;
    private Properties a;
    private List<ErroNFeTO> a = null;

    public NotaFiscalValidationDocumentV3_0() throws DSENBusinessException {
        try {
    ...
    private void a(String chaveProperty, String descricao, List<String> listaDetalhes) throws DSENBusinessException {
        if (!chaveProperty.equals("TNFe.SEQUENCE.infNFe.SEQUENCE.detArray.SEQUENCE.imposto.SEQUENCE.CHOICE.SEQUENCE.ICMS") && !chaveProperty.equals("TNFe.SEQUENCE.infNFe.SEQUENCE.detArray.SEQUENCE.imposto.SEQUENCE.CHOICE.SEQUENCE.ISSQN")) {
            ...
            try {
                ...
                block3 : switch (tag.getParticleType()) {
                    ...
                    case 4: {
                        ...
                        if (chaveProperty.equals("TNFe.SEQUENCE.infNFe.SEQUENCE.detArray.SEQUENCE.prod.SEQUENCE.NVEArray")) {
                            if (this.a(tag, xmlPai, listaDetalhes, chaveProperty)) {
                                this.b(tag, xmlPai, listaDetalhes, chaveProperty);
                            }
                            if (xmlCampo == null) break;
        ...
        if (xmlPai instanceof Object[]) {
            ...
            if (xmlPaiArray.length > 0) {
                ...
                for (Object pai : xmlPaiArray) {
                    ...
                    if (tagPai.getType().getContentModel() != null && tagPai.getType().getContentModel().getParticleType() == 2) {
