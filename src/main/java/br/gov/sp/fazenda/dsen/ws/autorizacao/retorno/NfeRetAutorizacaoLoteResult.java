 ...
 */
public class NfeRetAutorizacaoLoteResult
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeRetAutorizacaoLoteResult.class, true);

    public NfeRetAutorizacaoLoteResult() {
    }

    public NfeRetAutorizacaoLoteResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeRetAutorizacaoLoteResult)) {
            return false;
        }
        NfeRetAutorizacaoLoteResult other = (NfeRetAutorizacaoLoteResult)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetAutorizacao", ">nfeRetAutorizacaoLoteResult"));
    }
}
