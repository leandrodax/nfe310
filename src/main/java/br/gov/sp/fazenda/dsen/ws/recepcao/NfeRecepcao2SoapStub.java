 ...
 */
public class NfeRecepcao2SoapStub
extends Stub
implements NfeRecepcao2Soap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", "nfeDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", ">nfeDadosMsg"), NfeDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", ">nfeRecepcaoLote2Result"));
        oper.setReturnClass(NfeRecepcaoLote2Result.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", "nfeRecepcaoLote2Result"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        NfeRecepcao2SoapStub.a[0] = oper;
    }

    public NfeRecepcao2SoapStub() throws AxisFault {
        this(null);
    }

    public NfeRecepcao2SoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public NfeRecepcao2SoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", ">nfeDadosMsg");
        this.b.add(qName);
        Class<NfeDadosMsg> cls = NfeDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2", ">nfeRecepcaoLote2Result");
        this.b.add(qName);
        cls = NfeRecepcaoLote2Result.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public NfeRecepcaoLote2Result nfeRecepcaoLote2(Element element, NfeDadosMsg nfeDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "nfeRecepcaoLote2"));
        ...
        try {
            return (NfeRecepcaoLote2Result)_resp;
        }
        catch (Exception _exception) {
            return (NfeRecepcaoLote2Result)JavaUtils.convert((Object)_resp, NfeRecepcaoLote2Result.class);
        }
    }

    static {
        NfeRecepcao2SoapStub.a();
    }
}
