 ...
 */
public class NfeConsultaNF2Result
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeConsultaNF2Result.class, true);

    public NfeConsultaNF2Result() {
    }

    public NfeConsultaNF2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeConsultaNF2Result)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2", ">nfeConsultaNF2Result"));
    }
}
