...
public class DSENRegistroProdutoConverter
extends DSGERegistroConverter {
    private static Map<String, String> a = new HashMap();

    protected Registro createBaseRegistro() {
        Registro base = new Registro();
        base.setTagXml("infProduto");
        Campo c = new Campo();
        c.setNome("qtde");
        c.setValueExp("#A");
        base.addCampo(c);
        base.setTipoRegistro("PRODUTO");
        return base;
    }

    protected InputStream getArquivoLayout(String version) {
        return this.getClass().getResourceAsStream(MessageFormat.format(DSENConstants.XML_PRODUTO_LAYOUT, StringHelper.getDigits((String)version)));
    }
    ...
    public static void main(String[] args) {
        try {
            DSENRegistroProdutoConverter converter = new DSENRegistroProdutoConverter();
            Scanner scanner = new Scanner(converter.getClass().getResourceAsStream("PRODUTO.txt"));
            ...
            registroTOMap.put("I", ProdutoTO.class.getCanonicalName());
            registroTOMap.put("A", RegistroA.class.getCanonicalName());
            registroTOMap.put("M", RegistroM.class.getCanonicalName());
            registroTOMap.put("N", IcmsTO.class.getCanonicalName());
            registroTOMap.put("O", IpiTO.class.getCanonicalName());
    ...
    static {
        a.put("I", ProdutoTO.class.getCanonicalName());
        a.put("A", RegistroA.class.getCanonicalName());
        a.put("M", RegistroM.class.getCanonicalName());
        a.put("N", IcmsTO.class.getCanonicalName());
        a.put("O", IpiTO.class.getCanonicalName());
    }
}
