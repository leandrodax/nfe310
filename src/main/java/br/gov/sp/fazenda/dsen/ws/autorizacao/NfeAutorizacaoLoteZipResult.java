...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeAutorizacaoLoteZipResult.class, true);

    public NfeAutorizacaoLoteZipResult() {
    }

    public NfeAutorizacaoLoteZipResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeAutorizacaoLoteZipResult)) {
            return false;
        }
        NfeAutorizacaoLoteZipResult other = (NfeAutorizacaoLoteZipResult)obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeAutorizacao", ">nfeAutorizacaoLoteZipResult"));
    }
}
