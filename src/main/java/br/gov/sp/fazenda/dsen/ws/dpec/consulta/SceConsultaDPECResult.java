 ...
 */
public class SceConsultaDPECResult
...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(SceConsultaDPECResult.class, true);

    public SceConsultaDPECResult() {
    }

    public SceConsultaDPECResult(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof SceConsultaDPECResult)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCEConsultaRFB", ">sceConsultaDPECResult"));
    }
}
