 ...
 */
public class SCERecepcaoRFBSoapStub
extends Stub
implements SCERecepcaoRFBSoap {
    ...
    private static void a() {
        ...
        ParameterDesc param = new ParameterDesc(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", "sceDadosMsg"), 1, new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", ">sceDadosMsg"), SceDadosMsg.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", ">sceRecepcaoDPECResult"));
        oper.setReturnClass(SceRecepcaoDPECResult.class);
        oper.setReturnQName(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", "sceRecepcaoDPECResult"));
        oper.setStyle(Style.DOCUMENT);
        oper.setUse(Use.LITERAL);
        SCERecepcaoRFBSoapStub.a[0] = oper;
    }

    public SCERecepcaoRFBSoapStub() throws AxisFault {
        this(null);
    }

    public SCERecepcaoRFBSoapStub(URL endpointURL, Service service) throws AxisFault {
        this(service);
        this.cachedEndpoint = endpointURL;
    }

    public SCERecepcaoRFBSoapStub(Service service) throws AxisFault {
        ...
        QName qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", ">sceDadosMsg");
        this.b.add(qName);
        Class<SceDadosMsg> cls = SceDadosMsg.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
        qName = new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCERecepcaoRFB", ">sceRecepcaoDPECResult");
        this.b.add(qName);
        cls = SceRecepcaoDPECResult.class;
        this.a.add(cls);
        this.c.add(beansf);
        this.d.add(beandf);
    }
    ...
    public SceRecepcaoDPECResult sceRecepcaoDPEC(Element element, SceDadosMsg sceDadosMsg) throws RemoteException {
        if (this.cachedEndpoint == null) {
        ...
        _call.setOperationName(new QName("", "sceRecepcaoDPEC"));
        ...
        try {
            return (SceRecepcaoDPECResult)_resp;
        }
        catch (Exception _exception) {
            return (SceRecepcaoDPECResult)JavaUtils.convert((Object)_resp, SceRecepcaoDPECResult.class);
        }
    }

    static {
        SCERecepcaoRFBSoapStub.a();
    }
}
