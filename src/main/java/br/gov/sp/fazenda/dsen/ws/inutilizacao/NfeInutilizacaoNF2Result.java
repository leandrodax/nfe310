...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(NfeInutilizacaoNF2Result.class, true);

    public NfeInutilizacaoNF2Result() {
    }

    public NfeInutilizacaoNF2Result(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NfeInutilizacaoNF2Result)) {
            return false;
        }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", ">nfeInutilizacaoNF2Result"));
    }
}
