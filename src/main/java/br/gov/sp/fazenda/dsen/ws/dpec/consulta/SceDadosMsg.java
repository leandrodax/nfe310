...
MixedContentType {
    ...
    private static TypeDesc a = new TypeDesc(SceDadosMsg.class, true);

    public SceDadosMsg() {
    }

    public SceDadosMsg(MessageElement[] _any) {
        this.a = _any;
    }
    ...
    static {
        a.setXmlType(new QName("http://www.portalfiscal.inf.br/nfe/wsdl/SCEConsultaRFB", ">sceDadosMsg"));
    }
}
