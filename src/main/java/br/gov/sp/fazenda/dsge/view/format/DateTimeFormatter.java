...
extends MaskFormatter {
    private static final long a = 121053567512173343L;

    public DateTimeFormatter() throws ParseException {
        super("##/##/#### ##:##:##");
    }
    ...
    public Object stringToValue(String value) throws ParseException {
        ...
        Date d = DateHelper.getDateTime((String)value, (SimpleDateFormat)DateHelper.DATE_TIME_FORMAT);
        if (d == null) {
            throw new ParseException(DSGEMessageConstants.DATE_TIME_INVALID_MSG, 0);
        }
        return d;
    }
    ...
    public String valueToString(Object value) throws ParseException {
        ...
        if (value != null) {
            if (value instanceof Calendar) {
                valueString = DateHelper.formataDataHora((Date)((Calendar)value).getTime(), (SimpleDateFormat)DateHelper.DATE_TIME_FORMAT);
            } else if (value instanceof Date) {
                valueString = DateHelper.formataDataHora((Date)((Date)value), (SimpleDateFormat)DateHelper.DATE_TIME_FORMAT);
            }
        } else {
