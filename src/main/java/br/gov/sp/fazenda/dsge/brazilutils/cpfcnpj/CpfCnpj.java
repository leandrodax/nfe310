...
implements Validable {
    ...
    public static char getModule11Dv(String number, boolean isCpf) {
        ...
        for (int i = n.length() - 1; i >= 0; --i) {
            int digit = Integer.parseInt(String.valueOf(n.charAt(i)));
            sum += digit * coeficient;
            if (++coeficient <= 9 || isCpf) continue;
            coeficient = 2;
        }
        int dv = 11 - sum % 11;
        if (dv >= 10) {
    ...
    public static String completeDv(String number) {
        if (number != null) {
            ...
            n = n + CpfCnpj.getModule11Dv((String)n, (boolean)isCpf);
            n = n + CpfCnpj.getModule11Dv((String)n, (boolean)isCpf);
            return n;
        }
        return null;
    ...
    public static String extractDv(String completeNumber) {
        if (completeNumber != null) {
            ...
            boolean isCpf = n.length() == 9;
            return "" + CpfCnpj.getModule11Dv((String)completeNumber, (boolean)isCpf);
        }
        return null;
    }
    ...
    public String getCpfCnpj() {
        if (this.b != null) {
            return this.b.replaceAll("([0-9]{3})([0-9]{3})([0-9]{3})([0-9]{2})", "$1\\.$2\\.$3-$4");
        }
        return null;
    }

    public boolean isCnpj() {
        return this.b != null && this.b.length() == 14;
    }
    ...
    public boolean isValid() {
        return CpfCnpj.isValid((String)this.getNumber());
    }

    public void setCpfCnpj(String cpfCnpj) {
        if (cpfCnpj != null) {
            this.b = cpfCnpj.replaceAll("[^0-9]*", "");
            if (this.isCpf()) {
                this.a = "###.###.###-##";
            } else if (this.isCnpj()) {
                this.a = "##.###.###/####-##";
