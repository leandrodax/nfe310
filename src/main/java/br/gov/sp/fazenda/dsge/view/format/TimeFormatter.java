 ...
 *  br.gov.sp.fazenda.dsge.view.format.TimeFormatter
 */
...
extends MaskFormatter {
    ...
    public Object stringToValue(String value) throws ParseException {
        ...
        Date d = DateHelper.getDateTime((String)value, (SimpleDateFormat)DateHelper.TIME_FORMAT);
        if (d == null) {
            throw new ParseException(DSGEMessageConstants.HOUR_INVALID_MSG, 0);
        }
        return d;
    }
    ...
    public String valueToString(Object value) throws ParseException {
        ...
        if (value != null) {
            if (value instanceof Calendar) {
                valueString = DateHelper.formataDataHora((Date)((Calendar)value).getTime(), (SimpleDateFormat)DateHelper.TIME_FORMAT);
            } else if (value instanceof Date) {
                valueString = DateHelper.formataDataHora((Date)((Date)value), (SimpleDateFormat)DateHelper.TIME_FORMAT);
            }
        } else {
