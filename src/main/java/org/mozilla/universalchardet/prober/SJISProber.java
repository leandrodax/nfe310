...
extends CharsetProber {
    ...
    private SJISContextAnalysis a;
    private SJISDistributionAnalysis a;
    private byte[] a = new byte[2];
    private static final SMModel a = new SJISSMModel();
    ...
    public CharsetProber.ProbingState handleData(byte[] buf, int offset, int length) {
        ...
        for (int i = offset; i < maxPos; ++i) {
            ...
            if (i == offset) {
                this.a[1] = buf[offset];
                this.a.handleOneChar(this.a, 2 - charLen, charLen);
                this.a.handleOneChar(this.a, 0, charLen);
                continue;
            }
            this.a.handleOneChar(buf, i + 1 - charLen, charLen);
