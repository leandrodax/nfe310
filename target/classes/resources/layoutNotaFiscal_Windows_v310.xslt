		...
		<!-- NOTAFISCAL -->
			...
			<xsl:for-each select="x:NFe/x:infNFe">
				...
				<xsl:for-each select="x:ide">
					...
					<xsl:value-of select="x:dhEmi"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:dhSaiEnt"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:hSaiEnt"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:tpNF"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:idDest"/><xsl:text>|</xsl:text>
					...
					<xsl:value-of select="x:indFinal"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:indPres"/><xsl:text>|</xsl:text>
				...
				<xsl:for-each select="x:dest">
					<xsl:text>&#10;E|</xsl:text>
					<xsl:value-of select="x:xNome"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:indIEDest"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:IE"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:ISUF"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:IM"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:email"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:idEstrangeiro"/><xsl:text>|</xsl:text>
				...
				<xsl:for-each select="x:det">
					...
					<xsl:for-each select="x:prod">
						...
						<xsl:value-of select="x:NVE"/><xsl:text>|</xsl:text>
						...
						<xsl:value-of select="x:nRECOPI"/><xsl:text>|</xsl:text>	
						...
						<xsl:for-each select="x:DI">
							...
							<xsl:value-of select="x:tpViaTransp"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:tpIntermedio"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:cExportador"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:vAFRMM"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:CNPJ"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:UFTerceiro"/><xsl:text>|</xsl:text>
							...
							<xsl:for-each select="x:adi">
								...
								<xsl:value-of select="x:nDraw"/><xsl:text>|</xsl:text>
							</xsl:for-each>
							<!-- /I25 -->
						...
						<!-- I50 -->
						<xsl:for-each select="x:detExport">
							<xsl:text>&#10;I50|</xsl:text>
							<xsl:value-of select="x:nDraw"/><xsl:text>|</xsl:text>
							
							<!-- I52 -->
							<xsl:for-each select="x:exportInd">
								<xsl:text>&#10;I52|</xsl:text>
								<xsl:value-of select="x:nRE"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:chNFe"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:qExport"/><xsl:text>|</xsl:text>
							</xsl:for-each>
							<!-- /I52 -->
						...
						<xsl:for-each select="x:comb">
							...
							<xsl:value-of select="x:pMixGN"/><xsl:text>|</xsl:text>	
					...
					<xsl:for-each select="x:imposto">
						...
						<xsl:for-each select="x:ICMS">
							...
							<xsl:for-each select="x:ICMS20">
								...
								<xsl:value-of select="x:pICMS"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:vICMS"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:vICMSDeson"/><xsl:text>|</xsl:text>
							...
							<xsl:for-each select="x:ICMS51">
								...
								<xsl:value-of select="x:vBC"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:pICMS"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:vICMSOp"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:pDif"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:vICMSDif"/><xsl:text>|</xsl:text>
								<xsl:value-of select="x:vICMS"/><xsl:text>|</xsl:text>
							</xsl:for-each>
							<!-- /N07 -->
						...
						<xsl:for-each select="x:ISSQN">
							...
							<xsl:value-of select="x:vDeducao"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:vOutro"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:vDescIncond"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:vDescCond"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:indISSRet"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:vISSRet"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:indISS"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:cServico"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:cMun"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:cPais"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:nProcesso"/><xsl:text>|</xsl:text>
							<xsl:value-of select="x:indIncentivo"/><xsl:text>|</xsl:text>
						</xsl:for-each>
						<!-- /U -->
						...
						<!-- U -->
						<xsl:for-each select="x:impostoDevol">
							<xsl:text>&#10;U|</xsl:text>
							<xsl:value-of select="x:pDevol"/><xsl:text>|</xsl:text>
							
							<!-- U02 -->
							<xsl:if test="x:IPI">
								<xsl:text>&#10;U02|</xsl:text>
								<xsl:value-of select="x:vIPIDevol"/><xsl:text>|</xsl:text>
							</xsl:if>
							<!-- /U02 -->
				...
				<xsl:for-each select="x:total">
					...
					<xsl:for-each select="x:ISSQNtot">
						...
						<xsl:value-of select="x:dCompet"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vDeducao"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vOutro"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vDescIncond"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vDescCond"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vISSRet"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:cRegTrib"/><xsl:text>|</xsl:text>
					</xsl:for-each>
					<!-- /W17 -->
				...
				<xsl:for-each select="x:pag">
					<!-- YA01 -->
						<xsl:text>&#10;YA02|</xsl:text>
						<xsl:value-of select="x:tPag"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:vPag"/><xsl:text>|</xsl:text>
					<!-- /YA01 -->
					
					<!-- YA04 -->
					<xsl:for-each select="x:card">
						<xsl:text>&#10;YA04|</xsl:text>
						<xsl:value-of select="x:CNPJ"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:tBand"/><xsl:text>|</xsl:text>
						<xsl:value-of select="x:cAut"/><xsl:text>|</xsl:text>
					</xsl:for-each>
					<!-- /YA04 -->
				...
				<xsl:for-each select="x:exporta">
					<xsl:text>&#10;ZA|</xsl:text>
					<xsl:value-of select="x:UFSaidaPais"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:xLocExporta"/><xsl:text>|</xsl:text>
					<xsl:value-of select="x:xLocDespacho"/><xsl:text>|</xsl:text>
				</xsl:for-each>
				<!-- /ZA -->
